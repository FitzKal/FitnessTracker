...
export default function OwnBMI() {
    ...
    const { data: details, isLoading: profileLoading, isError:isProfileError } = useQuery({
        queryKey:["bmiProfile"],
        queryFn:async() => {
     ...
     *         return (
     *             <div>
     *                 <h1 className={"text-center text-2xl mt-1"}>We have calculated your BMI according to your profile
     *                     data!</h1>
     ...
     *                         <p className={"text-xl"}>Your BMI is <strong
     *                             className={bmiDetails?.[0]}>{bmiDetails?.[1]}</strong></p>
     *                     </div>
     *                 </div>
