...
import {deleteExerciseFromList, getDailyGoalById} from "../../../services/DailyGoalService.ts";
...
export default function ExtendedDailyGoal() {
    ...
    const deleteExerciseFromListMutation = useMutation({
        mutationFn:(exerciseId:string|undefined)=> deleteExerciseFromList(goalId,exerciseId),
        onSuccess:(result) => {
                        ...
                        {data.exercisesDone.map((exercise: ExercisesDone) => (
                            <div key={exercise.exerciseId} className="group flex flex-col sm:flex-row sm:items-center justify-between p-5 hover:bg-gray-50 transition-colors">
                                ...
                                <div className="mt-3 sm:mt-0 pl-0 sm:pl-4">
                                   ...
                                   onClick={()=>deleteExerciseFromListMutation.mutate(exercise.exerciseId)} >
